...
public class AccountService {
    ...
    @Transactional
    public void updateAccount(Long accountId, String name, String email, String address, Boolean isStaff) {
        ...
        if (address != null && address.length() > 0 && !Objects.equals(account.getAddress(), address)){account.setAddress(address);}
        if (isStaff != null && !Objects.equals(account.getIsStaff(), name)){account.setAddress(address);}
